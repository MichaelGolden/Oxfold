...
import uk.ac.ox.osscb.phylo.PPfoldPhylogeneticCalculation2;
 ...
 *
 */
public class EvolProbabilitiesCalculator2 {
	...
	public static NucleotideProbsPrecise calculateEvolutionaryProbsPPfold(String [] sequences, ArrayList<String> sequenceNames, File treeFile, double p)
	{
		ArrayList<String> sequencesList = new ArrayList<String>();
		for(int i = 0 ; i < sequences.length ; i++)
		{
		...
		return calculateEvolutionaryProbsPPfold(sequencesList,sequenceNames,treeFile, p);
	}
	...
	public static NucleotideProbsPrecise calculateEvolutionaryProbsPPfold(ArrayList<String> sequences, ArrayList<String> sequenceNames, File treeFile, double p)
	{
		double[][] ppfold = null;
		try {
			ppfold = PPfoldPhylogeneticCalculation2.getPhyloProbs(sequences, sequenceNames, treeFile, p);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
