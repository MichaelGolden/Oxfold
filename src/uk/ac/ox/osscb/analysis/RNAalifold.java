...
public class RNAalifold {
	...
	public static String executable = "binaries/RNAalifold.exe";
	...
	public static RNAalifoldResult fold(File fastaInFile, String arguments)  throws Exception
	{
		ArrayList<String> sequences = new ArrayList<String>();
		ArrayList<String> sequenceNames = new ArrayList<String>();
		IO.loadFastaSequences(fastaInFile, sequences, sequenceNames);
		return fold(sequences, sequenceNames, arguments, false, false);
	}
