...
public class CoFoldProbabilitiesCalculator {
	
	private static final Logger log = LoggerFactory.getLogger(CoFoldProbabilitiesCalculator.class);
	...
	static {
		...
		log.info(String.format("%s %s:",
				Util.dateTime(), CoFoldProbabilitiesCalculator.class.getName()));
	}
	
	public CoFoldProbabilitiesCalculator(Grammar grammar) {
