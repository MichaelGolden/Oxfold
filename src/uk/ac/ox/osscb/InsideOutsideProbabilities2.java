...
public class InsideOutsideProbabilities2 {

	private final Logger log = LoggerFactory.getLogger(InsideOutsideProbabilities2.class);
	...
	public InsideOutsideProbabilities2(char[] nonTerminals, int strLen){
